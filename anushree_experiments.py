...
for dataset, label_col in DATASETS.items():
    ...
    for i, (train_indices, test_indices) in enumerate(k_fold_splits):
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["RUS_Fold "+str(i)] = round(end_time - start_time, 3)
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["ROS_Fold "+str(i)] = round(end_time - start_time, 3)
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["SMOGN_Fold "+str(i)] = round(end_time - start_time, 3)
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["Distributed SMOGN (k_partitions = 2)_Fold "+str(i)] = round(end_time - start_time, 3)
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["Distributed SMOGN (k_partitions = 4)_Fold "+str(i)] = round(end_time - start_time, 3)
        ...
        try:
            ...
            end_time = time.time()
            execution_times[dataset]["Distributed SMOGN (k_partitions = 8)_Fold "+str(i)] = round(end_time - start_time, 3)
